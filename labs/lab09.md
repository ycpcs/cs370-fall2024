...
Download [CS370\_Lab09.zip](src/CS370_Lab09.zip), saving it into the **CS370\_Fa23** directory.

Double-click on **CS370\_Lab09.zip** and extract the contents of the archive into a subdirectory called **CS370\_Lab09**

Open CLion, select **CS370\_Fa23** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab09** subdirectory). Uncomment the line
...
Download [CS370\_Lab09\_Solution.zip](sol/CS370_Lab09_Solution.zip), saving it into the **CS370\_Fa23** directory.
...
Open CLion, select **CS370\_Fa23** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab09\_Solution** subdirectory). Uncomment the line
